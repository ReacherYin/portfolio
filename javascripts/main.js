(function() {
  ...
  tw = {
    ...
    about: {
      title: "關於我",
      desc: "				我是殷執鈞，畢業於逢甲大學，目前居住在臺北，曾經擔任過視覺設計、UI設計、前端工程師。  				我奉行『設計，是用來解決問題的。』的思維，當我在著手一項專案的時候，通常優先思考，				要達成什麼目的或是定義出問題，再來思考如何設計以符合需求，同時把使用者經驗放在第一位，				最後才考慮視覺表現。除了設計，我興趣廣泛，也玩音樂、研究金融商品，喜歡旅遊、電影與美食，				喜歡研究稀奇古怪的新事物。充分感受生活，我認為有助於從不同的角度去看待事情，				也有更多元的思考幫助設計發想。如果對我的作品有興趣，歡迎與我聯絡！			"
    },
    exp: {
      title: "經歷",
